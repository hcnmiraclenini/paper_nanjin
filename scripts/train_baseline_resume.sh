...
RESUME_CHECKPOINT="/root/data/huangchanni/checkpoints/moe_nanjin/best_model_epoch_047_mape_33.01.pth"
...
echo "  - 专家配置：1×ShortTermExpert (GRU) + 1×LongTermExpert (Transformer) + 1×StatisticExpert (MLP)"
echo "  - 专家数量：3个"
...
echo ""
echo "目标："
echo "  - 尝试在测试集MAPE 19.41%的基础上进一步改善"
echo "  - 观察是否能在验证集和测试集上都获得更好的结果"
echo ""
echo "=========================================="
echo ""
